...
@section('content')
    <div class="mb-3 ml-3 mt-3">
        <h3>რეპორტი > ნაქირავები ბანერები</h5>
    </div>
    <h3 class="ml-3 mt-3 mb-5">ჯამური გასავალი: {{ $total }}ლ</h3>

    <div class="table-responsive">
        <div class="table-responsive">
            <table class="table table-striped custom-table mb-0 ">
                <thead>
                    <form action="{{ route('report.outdoor') }}" method="get">
                        <tr>
                            ...
                            <th class="text-center">ჯამური გადახდა</th>
                ...
                <tbody>
                    @foreach ($payments as $payment)
                        <tr>
                            ...
                            <td class="text-center"><a href="/outdoor-banner/{{ $payment->banner_id }}">{{ $payment->banner_id }}</a></td>
