    ...
    <div class="page-header">
        <div class="row align-items-center">
            ...
            <div class="col-auto float-right ml-auto">
                <a href="#" class="btn add-btn " data-toggle="modal" data-target="#add_type"><i class="fa fa-plus"></i>ბანერის ტიპის დამატება</a>
            </div>
            @endif
        </div>
    </div>
                    ...
                    <thead>
                        <tr>
                            <form>
                                ...
                                <th class="text-center">ბანერის ტიპი</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="{{ route('delete.type', ['id' => $type->id]) }}" method="post">
                                    @csrf
                                    @method('delete')
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">ტიპის დამატება</h5>
