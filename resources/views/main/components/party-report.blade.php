...
@section('content')
    <div class="mb-3 ml-3 mt-3">
        <h3>რეპორტი > ფართების მოიჯარეები</h5>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-striped custom-table mb-0 ">
            <thead>
                <form action="{{ route('report.party') }}" method="get">
                    <tr>
                        <th class="text-center">
                            <div class="form-group">
                                <input autocomplete="off" class="form-control" name='filter_tenant' placeholder="მოიჯარე"
                                    type="text">
                            </div>
                        </th>
                ...
                @foreach ($payments as $payment)
                    <tr>
                        ...
                        <td class="text-center"><a
                                href="/party/{{ $payment->banner_id }}">{{ $payment->banner_id }}</a></td>
